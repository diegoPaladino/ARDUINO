...
const char* ssid = "VIVO-A050";

//Senha da rede
const char* password = "9KCVRJ3M4a";

//IP do ESP (para voce acessar pelo browser)
IPAddress ip(192, 168, 15, 7); //Gateway Padrão. Esse será o valor que vai ser digitado no browser

//IP do roteador da sua rede wifi
IPAddress gateway(192, 168, 15, 1); //Endereço IPv4
